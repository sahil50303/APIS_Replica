...
async def insert_receipt(
    ...
    try:
        ...
        payload = {
            ...
            "MailCode": MailCode,
            "Daan_Patra_Code": Daan_Patra_Code,
            "OTHER_TYPE": OTHER_TYPE,
            "Work_By": Work_By,
            "PDC_CHEQUE": PDC_CHEQUE,
            "DOB": DOB,
            "DOA": DOA,
            "Response_FromId": Response_FromId,
            "Response_FromName": Response_FromName,
            "Cheque_Return_Date": Cheque_Return_Date,
            "InRMemory": InRMemory,
            "Receive_SDWName": Receive_SDWName,
            "Receive_CareOf": Receive_CareOf,
            "Receive_Add1": Receive_Add1,
            "Receive_Add2": Receive_Add2,
            "Receive_Add3": Receive_Add3,
            "Receive_District": Receive_District,
            "Receive_Country": Receive_Country,
            "Receive_Pincode": Receive_Pincode,
            "Receive_STD": Receive_STD,
            "Receive_ISD": Receive_ISD,
            "Receive_Mob2": Receive_Mob2,
            "Receive_Whatsapp": Receive_Whatsapp,
            "Receive_Sandipan": Receive_Sandipan,
            "Receive_SMS": Receive_SMS,
            "Receive_DShri": Receive_DShri,
            "Receive_DID": Receive_DID,
            "Person_Id": Person_Id,
            "Cause_Id": Cause_Id,
            ...
            "Data_Flag": Data_Flag,
            "FY_ID": FY_ID,
            "Receive_ISD2": Receive_ISD2,
            "Receive_ISD3": Receive_ISD3,
            "Receive_Prnt_PayMode": Receive_Prnt_PayMode,
            "Cont_whatsApp": Cont_whatsApp,
            "Cont_Email": Cont_Email,
            "Cont_Letter": Cont_Letter,
            "Cont_Phone": Cont_Phone,
            "Receive_Aadhar": Receive_Aadhar,
            "PerAdd1": PerAdd1,
            "PerAdd2": PerAdd2,
            "PerAdd3": PerAdd3,
            "PerCountry_Code": PerCountry_Code,
            "PerState_Code": PerState_Code,
            "PerDistrict_Code": PerDistrict_Code,
            "AGFORM_REQUIRE": AGFORM_REQUIRE,
            "donationPurposeList": donationPurposeList,
